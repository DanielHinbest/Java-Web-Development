...
<form class="form-signin" method="post" action="./Register">
    ...
    <input name="ID" type="text" id="inputId" class="form-control" placeholder="ID" value="<%= id.trim() %>" />
    ...
    <input name="First_Name" type="text" id="inputFirstName" class="form-control" placeholder="First Name" value="<%= firstName.trim() %>" />
    
    <label for="inputLastName" class="sr-only">Last Name</label>
    <input name="Last_Name" type="text" id="inputLastName" class="form-control" placeholder="Last Name" value="<%= lastName.trim() %>" />
    
    <label for="inputEmailAddress" class="sr-only">Email Address</label>
    <input name="Email_Address" type="text" id="inputEmailAddress" class="form-control" placeholder="Email Address" value="<%= emailAddress.trim() %>" />
    
    <label for="inputProgramCode" class="sr-only">Program Code</label>
    <input name="Program_Code" type="text" id="inputProgramCode" class="form-control" placeholder="Program Code" value="<%= programCode.trim() %>" />
    
    <label for="inputProgramDescription" class="sr-only">Program Description</label>
    <input name="Program_Description" type="text" id="inputProgramDescription" class="form-control" placeholder="Program Description" value="<%= programDescription.trim() %>" />
    
    <label for="inputYear" class="sr-only">Year of Study</label>
    <input name="Year" type="text" id="inputYear" class="form-control" placeholder="Year of Study" value="<%= year.trim() %>" />
